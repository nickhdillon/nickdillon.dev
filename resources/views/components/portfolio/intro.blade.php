    ...
    <div class="relative flex flex-col items-center max-w-xl mx-auto space-y-4 text-center group sm:px-4">
        <div class="z-0 flex flex-col items-center space-y-4">
            ...
            <h1 class="italic font-bold">
                <div
                    class="relative items-center justify-center inline-block w-auto h-auto px-1 mb-2 text-base font-semibold text-opacity-100 transition-all duration-300 rounded outline-none group active:ring-0 active:outline-none">
